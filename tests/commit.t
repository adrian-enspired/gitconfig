...
contains "$(trailers gen)" 'COM-77' 'the ticket trailer is added'

# --------------------------------------------------- a message given ---

model_reset
setup given COM-78.thing
printf 'change\n' >"$AT_TMP/given/file"
...
case $body in
    *COM-999*) not_ok 'and its invented ticket trailer too' ;;
...
contains "$body" 'issue: COM-90' 'while our own ticket trailer stays'
contains "$body" 'why it matters' 'and the body stays'

# --------------------------------------------------- um ---

model_reset
setup amend COM-85.thing
printf 'change\n' >"$AT_TMP/amend/file"
